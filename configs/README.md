# Configs - metadados do laboratorio

Esta pasta nao e usada diretamente pelo OrcaSlicer. Ela serve para guardar
...
- `versions.md`: versoes de firmware e OrcaSlicer em uso.

Opcionalmente, crie um `index.md` para links rapidos.
